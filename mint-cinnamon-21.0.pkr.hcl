_comment = "Built with `packer build -var-file=mint-cinnamon-21.0.pkr.hcl core_template.pkr.hcl`"
...
version = "1.1.0"
version_description = "Linux Mint 21.0 with VirtualBox Guest Additions 6.1.38"
vm_name = "mint-cinnamon-21.0"
